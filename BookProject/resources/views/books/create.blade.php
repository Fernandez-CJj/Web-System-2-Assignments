...
<body class="bg-gray-100 min-h-screen">
  ...
  <main class="max-w-2xl mx-auto px-6 py-12">
    ...
    <div class="bg-white rounded-2xl shadow-md p-8">
      <h1 class="text-2xl font-bold text-gray-800 mb-1">Add New Book</h1>
      <p class="text-gray-500 text-sm mb-8">Fill in the details below to add a book to your library.</p>
